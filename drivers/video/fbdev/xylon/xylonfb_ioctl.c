...
int xylonfb_ioctl(struct fb_info *fbi, unsigned int cmd, unsigned long arg)
{
	...
	switch (cmd) {
	case FBIOGET_VBLANK:
		XYLONFB_DBG(INFO, "FBIOGET_VBLANK");
	...
	case FBIO_WAITFORVSYNC:
		XYLONFB_DBG(INFO, "FBIO_WAITFORVSYNC");
	...
	case XYLONFB_VSYNC_CTRL:
		XYLONFB_DBG(INFO, "XYLONFB_VSYNC_CTRL");
	...
	case XYLONFB_LAYER_IDX:
		XYLONFB_DBG(INFO, "XYLONFB_LAYER_IDX");
		var32 = ld->fd->id;
		put_user(var32, (u32 __user *)arg);
		break;

	case XYLONFB_LAYER_ALPHA:
		XYLONFB_DBG(INFO, "XYLONFB_LAYER_ALPHA");
	...
	case XYLONFB_LAYER_COLOR_TRANSP_CTRL:
		XYLONFB_DBG(INFO, "XYLONFB_LAYER_COLOR_TRANSP_CTRL");
		if (get_user(flag, (u8 __user *)arg))
			return -EFAULT;
	...
	case XYLONFB_LAYER_COLOR_TRANSP:
		XYLONFB_DBG(INFO, "XYLONFB_LAYER_COLOR_TRANSP");
	...
	case XYLONFB_LAYER_GEOMETRY:
		XYLONFB_DBG(INFO, "XYLONFB_LAYER_GEOMETRY");
	...
	case XYLONFB_LAYER_EXT_BUFF_SWITCH:
		XYLONFB_DBG(INFO, "XYLONFB_LAYER_EXT_BUFF_SWITCH");
		if (get_user(flag, (u8 __user *)arg))
			return -EFAULT;
	...
	case XYLONFB_HW_ACCESS:
		XYLONFB_DBG(INFO, "XYLONFB_HW_ACCESS");
